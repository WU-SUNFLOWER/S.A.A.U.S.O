...
baz_instance(14)
  ...
  auto expected_printv_result = PyList::New(isolate_);
  AppendExpected(expected_printv_result, isolate_->factory()->NewSmiFromInt(13));
  AppendExpected(expected_printv_result, isolate_->factory()->NewSmiFromInt(19));
  AppendExpected(expected_printv_result, isolate_->factory()->NewSmiFromInt(26));
  AppendExpected(expected_printv_result, isolate_->factory()->NewSmiFromInt(14));
  ExpectPrintResult(expected_printv_result);
}
