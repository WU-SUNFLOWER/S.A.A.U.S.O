...
从本科毕业论文的评价标准来看，本文的创新性主要体现为围绕特定目标完成系统级组织、关键机制取舍和真实工程落地，而非提出全新的编程语言理论或工业级虚拟机优化算法。具体而言，本文的工作与创新点主要体现在以下几个方面。
...
[2] Anthony Shaw. CPython设计与实现[M]. 史海, 赵羽, 陈啸, 等,译. 北京: 人民邮电出版社, 2024.
