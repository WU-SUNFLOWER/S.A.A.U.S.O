...
**本项目的目的不在于复刻完整的 Python 语言，或者代替成熟的工业级 CPython 虚拟机；而在于完成一个具备清晰架构、适合教学展示、裁剪定制或二次开发的轻量级 PVM 后端。**
...
## 5. 当前本项目已经支持的 Python 能力

### 5.1 概述

正如《开题报告》所述，本项目旨在提供一个支持 Python 语言核心功能的轻量级 PVM 技术方案，当前并不追求完整复刻 Python 语言的全部功能。

目前本项目已经覆盖的 Python 语言核心能力包括：
