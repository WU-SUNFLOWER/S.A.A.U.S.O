...
#ifndef SRC_BUILTINS_BUILTINS_PY_TYPE_OBJECT_METHODS_H_
#define SRC_BUILTINS_BUILTINS_PY_TYPE_OBJECT_METHODS_H_
...
#endif  // SRC_BUILTINS_BUILTINS_PY_TYPE_OBJECT_METHODS_H_
