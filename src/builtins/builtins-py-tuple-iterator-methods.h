...
#ifndef SRC_BUILTINS_BUILTINS_PY_TUPLE_ITERATOR_METHODS_H_
#define SRC_BUILTINS_BUILTINS_PY_TUPLE_ITERATOR_METHODS_H_
...
#endif  // SRC_BUILTINS_BUILTINS_PY_TUPLE_ITERATOR_METHODS_H_
