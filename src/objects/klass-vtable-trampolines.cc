...
MaybeHandle<PyObject> KlassVtableTrampolines::Add(Isolate* isolate,
  ...
  if (!Runtime_InvokeMagicOperationMethod(
           isolate, self, args, Handle<PyDict>::null(), ST(add, isolate))
           .ToHandle(&result)) {
...
MaybeHandle<PyObject> KlassVtableTrampolines::Sub(Isolate* isolate,
  ...
  Handle<PyObject> result;
  if (!Runtime_InvokeMagicOperationMethod(
           isolate, self, args, Handle<PyDict>::null(), ST(sub, isolate))
           .ToHandle(&result)) {
    return kNullMaybeHandle;
  }
  return result;
...
MaybeHandle<PyObject> KlassVtableTrampolines::Mul(Isolate* isolate,
  ...
  Handle<PyObject> result;
  if (!Runtime_InvokeMagicOperationMethod(
           isolate, self, args, Handle<PyDict>::null(), ST(mul, isolate))
           .ToHandle(&result)) {
    return kNullMaybeHandle;
  }
  return result;
...
MaybeHandle<PyObject> KlassVtableTrampolines::Div(Isolate* isolate,
  ...
  Handle<PyObject> result;
  if (!Runtime_InvokeMagicOperationMethod(
           isolate, self, args, Handle<PyDict>::null(), ST(div, isolate))
           .ToHandle(&result)) {
    return kNullMaybeHandle;
  }
  return result;
...
MaybeHandle<PyObject> KlassVtableTrampolines::Mod(Isolate* isolate,
  ...
  Handle<PyObject> result;
  if (!Runtime_InvokeMagicOperationMethod(
           isolate, self, args, Handle<PyDict>::null(), ST(mod, isolate))
           .ToHandle(&result)) {
    return kNullMaybeHandle;
  }
  return result;
...
Maybe<uint64_t> KlassVtableTrampolines::Hash(Isolate* isolate,
  ...
  Handle<PyObject> result;
  if (!Runtime_InvokeMagicOperationMethod(
           isolate, self, Handle<PyTuple>::null(), Handle<PyDict>::null(),
           ST(hash, isolate))
           .ToHandle(&result)) {
    return kNullMaybe;
  }
